...
@app.get("/dashboard/manual-actions")
async def manual_actions_dashboard(phone: str = Depends(verify_dashboard_cookie)):
    return FileResponse("/app/static/manual_actions.html")
